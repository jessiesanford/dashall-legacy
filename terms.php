<?php 
	...
	$pageDesc = 'The terms of service and legality of all things DashAll and what you should know.';
?>
<!doctype html>
	...
	<div class="wrap">
		...
		<div class="section">
			<div class="page_heading">
				...
				<h2 class="page_desc">The legality of all things DashAll and what you should know.</h2>
			</div>

			<p class="align_center">
				<strong>PLEASE READ THESE TERMS CAREFULLY BEFORE USING THIS WEBSITE. UTILIZING THIS WEBSITE INDICATES THAT YOU ACCEPT THESE TERMS. 
				IF YOU DO NOT ACCEPT THESE TERMS ("TERMS"), DO NOT USE THIS WEBSITE.</strong>
			</p>

			<p class="align_center">
				Effective and Last Updated: May 2016
			</p>

			<p>
				This website is operated by DashAll. Throughout the site, the terms “we”, “us” and “our” refer to DashAll. 
				DashAll offers this website, including all information, tools and services available from this site to you, the user, 
			...
			<p>In no case shall DashAll, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.</p>

			<h4>SECTION 14 - INDEMNIFICATION</h4>

			<p>You agree to indemnify, defend and hold harmless DashAll and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
			...
			<p>Questions about the Terms of Service should be sent to us at contact@DashAll.com.</p>
